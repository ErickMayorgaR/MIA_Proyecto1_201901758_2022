...
void Copy::executeCopy() {
    ...
    return copyFile(npath1, name1, npath2, name2);
}


void Copy::copyFile(std::string _path_cut, std::string _name_cut, std::string _path_paste, std::string _name_paste) {
