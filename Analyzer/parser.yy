...
ADMIN_USERS_GROUPS: "_login" PARAMS {x = newCommand("__LOGIN",parameters);}
                  ...
                  | "_CHOWN" PARAMS {x = newCommand("__CHOWN",parameters);}
                  | "_CHGRP" PARAMS {x = newCommand("__CHGRP",parameters);}
;
...
FILESYSTEM: "_CHMOD" PARAMS {x = newCommand("__CHMOD",parameters);}
            ...
            | "_REN" PARAMS {x = newCommand("__REN",parameters);}
            | "_CP" PARAMS {x = newCommand("__CP",parameters);}
            | "_MV" PARAMS {x = newCommand("__MV",parameters);}
            | "_FIND" PARAMS {x = newCommand("__FIND",parameters);}
            | "_LOSS" PARAMS {x = newCommand("__LOSS",parameters);}
            | "_RECOVERY" PARAMS {x = newCommand("__RECOVERY",parameters);}
;
